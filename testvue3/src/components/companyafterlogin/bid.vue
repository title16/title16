            ...
            <el-row >
                ...
                <el-col :span="12">
                    <div ><br>
                      ...
                      <p style="text-align:left; font-size:15px">项目名：</p><br>
                      <p style="text-align:left; font-size:15px">甲方</p>
                      <p style="text-align:left; font-size:15px">公司编号：{{company_id}}</p>
                      <p style="text-align:left; font-size:15px">公司名：</p>
                      <p style="text-align:left; font-size:15px">乙方</p>
                      <p style="text-align:left; font-size:15px">工作室编号：{{studio_id}}</p>
...
export default {
     data() {
      ...
      return {
           project_id:this.$route.query.biddingproject_id,
           studio_id:this.$route.query.biddingstudio_id,
